...
//#include <pix.h>
//
//#include "Core/Platform/Rendering/TextureManagerInc.h"
//#include "Core/Platform/Rendering/DX12/DXHelper.h"
//
//// DirectX data
//ID3D12Device* ORBImContext::m_pD3dDevice = NULL;
//ID3D10Blob* ORBImContext::m_pVertexShaderBlob = NULL;
//ID3D10Blob* ORBImContext::m_pPixelShaderBlob = NULL;
//ID3D12RootSignature* ORBImContext::m_pRootSignature = NULL;
//ID3D12PipelineState* ORBImContext::m_pPipelineState = NULL;
//DXGI_FORMAT ORBImContext::m_RTVFormat = DXGI_FORMAT_UNKNOWN;
//ID3D12Resource* ORBImContext::m_pFontTextureResource = NULL;
//D3D12_CPU_DESCRIPTOR_HANDLE  ORBImContext::m_FontSrvCpuDescHandle = {};
//D3D12_GPU_DESCRIPTOR_HANDLE  ORBImContext::m_FontSrvGpuDescHandle = {};
//
//FrameResources* ORBImContext::m_pFrameResources = NULL;
//UINT ORBImContext::m_uiNumFramesInFlight = 0;
//UINT ORBImContext::m_uiFrameIndex = UINT_MAX;
//
//ORBImContext::ORBImContext(DX12RenderContext* pContext)
//{
//	/* Assign variables */
//	m_pContext = pContext;
...
//}
//
//void ORBImContext::NewFrame()
//{
//	if (!m_pPipelineState)
//		CreateDeviceObjects();
//}
//
//void ORBImContext::Draw(ImDrawData* drawData, ID3D12GraphicsCommandList* pCommandList)
//{
//	m_pCommandList = pCommandList;
//	Draw(drawData);
//}
//
//void ORBImContext::Draw(ImDrawData* drawData)
//{
//	ID3D12DescriptorHeap* heaps[] = { m_pContext->GetTextureManager()->GetSRVHeap() };
...
//}
//
//bool ORBImContext::CreateDeviceObjects()
//{
//	if (!m_pD3dDevice)
//		return false;
//
...
//}
//
//void ORBImContext::InvalidateDeviceObjects()
//{
//	if (!m_pD3dDevice)
//		return;
//
...
//}
//
//void ORBImContext::Deinitialize()
//{
...
//}
//
//void ORBImContext::CreateFontsTexture()
//{
//	// Build texture atlas
...
//	m_FontSrvCpuDescHandle = pTextureManager->GetCPUHandle(uiID);
//	m_FontSrvGpuDescHandle = pTextureManager->GetGPUHandle(uiID);
//
