...
static LinearAlloc s_alloc;
static Foo* s_pFoo;

class LinearAllocTest : public ::testing::Test
{
protected:

	LinearAllocTest() {}

	~LinearAllocTest() override {}
...
TEST_F(LinearAllocTest, Initialize)
{
...
TEST_F(LinearAllocTest, Allocate)
{
...
TEST_F(LinearAllocTest, Destroy)
{
	s_alloc.Destroy();
