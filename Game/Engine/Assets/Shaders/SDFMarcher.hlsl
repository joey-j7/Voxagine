...
MarchResult MarchLight(float3 v3Origin, float3 v3Direction, float3 v3ChunkSize, int iMaxSteps) {
	...
	for (int i = 0; i < iMaxSteps; i++) {	
		...
		v3Distance += (v3Mask * v3SignedRayDirection * v3InvDirection) * 2.0;
		v3Position += (v3Mask * v3SignedRayDirection) * 2.0;
